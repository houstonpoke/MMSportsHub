...
st.title("🏈 NCAA Football - Peabody/Walters Model")

# Simulated power ratings for top college teams
TEAM_POWER = {
    "Georgia": 6.2,
    "Michigan": 6.0,
    "Alabama": 5.8,
...
odds = get_real_odds(sport="americanfootball_ncaaf", market="h2h,spreads,totals")
...
if isinstance(odds, list):
    ...
    st.error("Could not load NCAA Football odds.")